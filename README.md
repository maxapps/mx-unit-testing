...
Simple unit testing following format of [Jest](https://jestjs.io/).

Three global functions are all that's needed:

* **describe()** Describes a suite of tests. [see Jest.describe](https://jestjs.io/docs/api#describename-fn)
* **test()** Defines a test (a series of expectations) [see Jest.test](https://jestjs.io/docs/api#testname-fn-timeout)
* **expect()** Specifies an expectation typically with an associated **matcher** [see Jest.expect](https://jestjs.io/docs/expect#tobeclosetonumber-numdigits)
  * Matchers are methods such as **toBe** or **toMatch** which are tested for an expected value.


## Unit tests on the MxUnitTesting system
